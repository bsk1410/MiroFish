...
# This fixes OASIS third-party library reading files without specifying encoding
# ============================================================
import sys
import os
...
if sys.platform == 'win32':
    ...
    def _utf8_open(file, mode='r', buffering=-1, encoding=None, errors=None, 
        ...
        """
        Wrap open() function, defaulting to UTF-8 encoding for text mode
...
# Add filter at module load time, ensuring it takes effect before camel code executes
...
def fetch_new_actions_from_db(
    ...
    Args:
        ...
        last_rowid: Last read max rowid value (using rowid instead of created_at because different platforms have different created_at formats)
...
def _enrich_action_context(
    ...
    try:
        ...
        # Create comment: enrich with commented post info
...
async def main():
    ...
    # Create shutdown event at start of main function, ensuring entire program can respond to exit signals
...
def setup_signal_handlers(loop=None):
    ...
    2. Give program a chance to clean up resources (close databases, environments, etc.)
    3. Then exit
    """
