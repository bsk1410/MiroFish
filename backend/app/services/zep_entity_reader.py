...
class ZepEntityReader:
    ...
    def get_all_nodes(self, graph_id: str) -> List[Dict[str, Any]]:
        ...
        logger.info(f"Got {len(nodes_data)} nodes total")
        return nodes_data
    ...
    def get_all_edges(self, graph_id: str) -> List[Dict[str, Any]]:
        ...
        logger.info(f"Got {len(edges_data)} edges total")
        return edges_data
    ...
    def filter_defined_entities(
        ...
        Filtering logic:
        - If node Labels only has "Entity", this entity doesn't match predefined types, skip
        - If node Labels contains labels other than "Entity" and "Node", it matches predefined types, keep
    ...
    def get_entity_with_context(
        ...
        """
        Get a single entity with its full context (edges and associated nodes, with retry)
