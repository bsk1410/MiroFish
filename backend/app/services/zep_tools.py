...
class ZepToolsService:
    ...
    def search_graph(
        ...
        Uses hybrid search (semantic+BM25) to search for relevant info in the graph.
        If Zep Cloud search API is unavailable, falls back to local keyword matching.
    ...
    def get_all_edges(self, graph_id: str, include_temporal: bool = True) -> List[EdgeInfo]:
        """
        Get all edges of the graph (paginated, with temporal info)
    ...
    def get_simulation_context(
        ...
        Comprehensively searches all info related to simulation requirements
        
        Args:
            graph_id: Graph ID
            simulation_requirement: Simulation requirement description
            limit: Quantity limit per info category
    ...
    def insight_forge(
        ...
        Most powerful hybrid retrieval function, auto-decomposes queries and multi-dimensional search:
        1. Uses LLM to decompose query into multiple sub-queries
        ...
        # Get all related entities' details (no quantity limit, complete output)
        entity_insights = []
    ...
    def _generate_sub_queries(
        ...
        Decomposes complex queries into multiple independently searchable sub-queries
        """
        system_prompt = """You are a professional query analysis expert. Your task is to decompose a complex query into multiple sub-queries that can be independently observed in a simulated world.
...
Return a JSON list of sub-queries."""
    ...
    def panorama_search(
        ...
        Get full picture view, including all related content and historical/expired info:
        ...
        This tool is suitable for scenarios requiring full event understanding and evolution tracking.
    ...
    def interview_agents(
        ...
        1. Auto-reads profile files to understand all simulation Agents
        2. Uses LLM to analyze interview needs and intelligently select most relevant Agents
        ...
        5. Integrates all interview results to generate interview report
        ...
        # Step 4: Call real interview API (no platform specified, dual-platform simultaneous interview)
        try:
            ...
            for i, agent_idx in enumerate(selected_indices):
                ...
                # Clean response text: remove markers, numbering, Markdown interference
