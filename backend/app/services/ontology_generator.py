...
A. **Fallback types (must be included, placed as the last 2 in the list)**:
   - `Person`: Fallback type for any natural person individual. When a person does not belong to a more specific person type, they are classified here.
   - `Organization`: Fallback type for any organizational entity. When an organization does not belong to a more specific organization type, it is classified here.
...
- Various people may appear in the text, such as "elementary school teacher", "passerby", "some netizen"
...
class OntologyGenerator:
    ...
    # Maximum text length to pass to LLM (50k characters)
    ...
    def _validate_and_process(self, result: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if fallbacks_to_add:
            ...
            if current_count + needed_slots > MAX_ENTITY_TYPES:
                ...
                # Remove from end (preserve more important specific types at the front)
