...
# China timezone activity config (Beijing time)
...
- User base is Chinese, must follow Beijing time daily schedule
- 0-5 AM almost no activity (activity coefficient 0.05)
- 6-8 AM gradually active (activity coefficient 0.4)
- 9-18 PM moderate activity during work hours (activity coefficient 0.7)
- 19-22 PM is peak period (activity coefficient 1.5)
- After 23 PM activity declines (activity coefficient 0.5)
- General pattern: low at dawn, increasing in morning, moderate during work, evening peak
...
- **Schedule follows Chinese daily patterns**: Almost no activity 0-5 AM, most active 19-22 PM
...
{{
    "agent_configs": [
        {{
            ...
            "active_hours": [<active hour list, considering Chinese schedule>],
        ...
        system_prompt = "You are a social media behavior analysis expert. Return pure JSON, configuration must follow Chinese daily schedule patterns."
