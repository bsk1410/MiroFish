...
class SimulationRunner:
    ...
    def start_simulation(
        ...
        try:
            ...
            # Fixes issues with third-party libraries (e.g., OASIS) reading files without specifying encoding
            env = os.environ.copy()
            ...
            # Use start_new_session=True to create new process group, ensuring all child processes can be killed via os.killpg
                        ...
                        try:
                            ...
                            if "event_type" in action_data:
                                ...
                                if event_type == "simulation_end":
                                    ...
                                    # If only one platform was running, check only that one
    ...
    def register_cleanup(cls):
        ...
        if is_debug_mode and not is_reloader_process:
            _cleanup_registered = True  # Mark as registered to prevent child process retry
            return
    ...
    def get_env_status_detail(cls, simulation_id: str) -> Dict[str, Any]:
        """
        Get detailed status information for simulation environment
    ...
    def close_simulation_env(
        ...
        """
        Close simulation environment (not the simulation process)
