...
class OasisProfileGenerator:
    ...
    def _search_zep_for_entity(self, entity: EntityNode) -> Dict[str, Any]:
        """
        Use Zep graph hybrid search to retrieve rich entity-related information
        
        Zep doesn't have a built-in hybrid search API, need to search edges and nodes separately then merge results.
    ...
    def _get_system_prompt(self, is_individual: bool) -> str:
        """Get system prompt"""
        base_prompt = "You are a social media user persona generation expert. Generate detailed, realistic personas for opinion simulation, maximally restoring existing real-world situations. Must return valid JSON format, all string values must not contain unescaped newlines. Use Chinese."
        return base_prompt
    ...
    def _build_individual_persona_prompt(
        ...
        return f"""Generate a detailed social media user persona for the entity, maximally restoring existing real-world situations.
...
2. persona: Detailed persona description (2000 characters plain text), must include:
   ...
   - Personal memory (important part of persona, describe this individual's connection to events, and their existing actions and reactions in events)
...
8. interested_topics: Interested topics array
...
"""
    ...
    def _build_group_persona_prompt(
        ...
        return f"""Generate a detailed social media account setting for an institution/group entity, maximally restoring existing real-world situations.
...
2. persona: Detailed account setting description (2000 characters plain text), must include:
   ...
   - Institutional memory (important part of persona, describe this institution's connection to events, and its existing actions and reactions in events)
